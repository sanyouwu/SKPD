...
class AltMin(object):
    def __init__(self,Z,RX,Y,lmbda_1,lmbda_2,m1,n1,m2,n2,d1,d2,R = 1,na = True, nb = True):
    ...
    def fun_predict(self,Z,RX,a,b,gamma):
        ...
        if self.R == 1:
            ...
            A,B,kron_ab = func_kron_ab(a,b,self.R,self.m1,self.n1,self.m2,self.n2,self.d1,self.d2)
            beta_hat = kron_ab[-1]
